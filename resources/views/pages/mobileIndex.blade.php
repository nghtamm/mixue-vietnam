...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="products-show-col col-md-9 px-0 d-sm-block" style="border-right: 1px solid #dfdfe3">
                        ...
                        @foreach ($products as $p)
                            <div class="products-option col" style="margin-bottom: var(--bs-gutter-y);">
                                <div class="card h-100" style="overflow: hidden;">
                                    <img src="{{ $p->product_image }}" class="card-img-top" alt="..." loading="lazy"
                                        style="height: 250px;">
                ...
                {{-- Button sử dụng khi người dùng ở dạng mobile --}}
                <button class="btn btn-success d-block d-md-none" type="button"
                    style="position: sticky; bottom:0; width:100%; z-index: 100; border-radius: 0"
                    data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom">Giỏ
                    hàng</button>
            </div>
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasBottomLabel">Giỏ hàng</h5>
            ...
            <div class="products px-3">
                @if (!Cart::content()->isEmpty())
                    <div class="row accordion"
                        style="display:flex; flex-wrap: nowrap; flex-direction: column; height: 500px; overflow-y: auto;">
                        @foreach ($content as $v_content)
                            <div class="cart d-flex mt-3" data-rowid="{{ $v_content->rowId }}" style="padding-right: 0">
                                <div class="col-1" data-bs-toggle="collapse"
                                    data-bs-target="#panelsStayOpen-collapse-{{ $v_content->rowId }}"
                                    aria-expanded="true" aria-controls="panelsStayOpen-collapse-{{ $v_content->rowId }}">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                @else
                    <div class="products-show-noti text-center" style="margin-top:">
